...
|------|-------------------|
| Cookie de consentement | 6 à 13 mois |
| Cookie analytics | 13 mois max |
| Cookie publicitaire | 13 mois max |
| Cookie de session | Durée de la session |

Le consentement doit être renouvelé au-delà de 13 mois.
...
│ cookie_consent│ [Entreprise]  │ 12 mois    │ Mémorisation du choix       │
└──────────────┴────────────────┴────────────┴─────────────────────────────┘
